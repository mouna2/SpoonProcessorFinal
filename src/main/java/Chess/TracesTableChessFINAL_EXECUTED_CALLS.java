...
public class TracesTableChessFINAL_EXECUTED_CALLS extends JFrame {
	int Row=0; 
	int MethodID=1; 
	int MethodName=2; 
	int RequirementID=3; 
	...
	File fout = new File("C:\\Users\\mouna\\ownCloud\\Share\\dumps\\TableLogChessEXEC.txt");

	FileOutputStream fos = new FileOutputStream(fout);
	
//	File fout2 = new File("C:\\Users\\mouna\\new_workspace\\SpoonProcessorFinal\\PredictionEvaluationChess.txt");
	File fout2 = new File("C:\\Users\\mouna\\ownCloud\\Share\\dumps\\PredictionEvaluationChessEXEC.txt");

	FileOutputStream fos2 = new FileOutputStream(fout2);
	
	//File foutGold2 = new File("C:\\Users\\mouna\\new_workspace\\SpoonProcessorFinal\\PredictionEvaluationChessGold2.txt");
	File foutGold2 = new File("C:\\Users\\mouna\\ownCloud\\Share\\dumps\\PredictionEvaluationChessGold2EXEC.txt");

	FileOutputStream fileGold2 = new FileOutputStream(foutGold2);
	
	File foutGold2TableLog = new File("C:\\Users\\mouna\\ownCloud\\Share\\dumps\\TableLogChessGOLD2EXEC.txt");
	...
	public TracesTableChessFINAL_EXECUTED_CALLS() throws SQLException, IOException {
...
if(CountMethodTGOLD2>0 && CountMethodTCalleeGOLD2>0) {
		...
		boolean entered=false; 
		if(CountMethodN+CountMethodNCallee==0 && methodtrace.getGold2()!=null ) {
...
//					+","+BothInParsedAndExecutedCallees
		...
		bwGold2.newLine();
		bwGold2.write("TRACE PURE GOLD METHOD LEVEL: "+PredictionCLASSTRACEMethodLevelPureGold2.toString()); 
		bwGold2.newLine();
		bwGold2.write("TRACE MIXED GOLD METHOD LEVEL: "+PredictionCLASSTRACEMethodLevelMixedGold2.toString()); 
		bwGold2.newLine();
		bwGold2.write("NO TRACE PURE GOLD METHOD LEVEL: "+PredictionCLASSNOTRACEMethodLevelPureGold2.toString()); 
		bwGold2.newLine();
		bwGold2.write("NO TRACE MIXED GOLD METHOD LEVEL: "+PredictionCLASSNOTRACEMethodLevelMixedGold2.toString()); 
		bwGold2.newLine();
		bwGold2.write("TRACE PURE GOLD CLASS LEVEL: "+PredictionCLASSTRACEClassLevelPureGold2.toString()); 
		bwGold2.newLine();
		bwGold2.write("TRACE MIXED GOLD CLASS LEVEL: "+PredictionCLASSTRACEClassLevelMixedGold2.toString()); 
		bwGold2.newLine();
		bwGold2.write("NO TRACE PURE GOLD CLASS LEVEL: "+PredictionCLASSNOTRACEClassLevelPureGold2.toString()); 
		bwGold2.newLine();
		bwGold2.write("NO TRACE MIXED GOLD CLASS LEVEL: "+PredictionCLASSNOTRACEClassLevelMixedGold2.toString()); 
		bwGold2.newLine();
		bwGold2.close();
...
//				};
	...
	public static void main(String[] args) throws SQLException, IOException {
		...
		TracesTableChessFINAL_EXECUTED_CALLS frame = new TracesTableChessFINAL_EXECUTED_CALLS();
