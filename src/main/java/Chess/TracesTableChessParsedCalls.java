...
public class TracesTableChessParsedCalls extends JFrame {
	int Row=0; 
	int MethodID=1; 
	int MethodName=2; 
	int RequirementID=3; 
	...
	File fout = new File("C:\\Users\\mouna\\new_workspace\\SpoonProcessorFinal\\TableLogParsedCallers.txt");
	FileOutputStream fos = new FileOutputStream(fout);
	
	File fout2 = new File("C:\\Users\\mouna\\new_workspace\\SpoonProcessorFinal\\PredictionEvaluationParsedCallers.txt");
	...
	public TracesTableChessParsedCalls() throws SQLException, IOException {
...
//DUPLICATE CLASSES
		...
		*/
			...
			bw.write(data[j][MethodID] + "," + data[j][MethodName] + "," + data[j][RequirementID] + "," + data[j][RequirementName] + "," + data[j][ClassID] + ","
					...
					//OnlyinParsedCallers	+","
					//+ OnlyinExecutedCallers+","+BothParsedAndExecutedCallers
					//+","+OnlyInParsedCallees+","
					//+OnlyInExecutedCallees +","+BothInParsedAndExecutedCallees+","+
					data[j][paramatersNumber]+","+ParametersAppended+","+data[j][MajorityParameters]+","+data[j][AtLeast1NParameter]
	...
	public static void main(String[] args) throws SQLException, IOException {
		...
		TracesTableChessParsedCalls frame = new TracesTableChessParsedCalls();
