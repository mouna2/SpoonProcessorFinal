...
public class TracesTableChessFINALROUND2MethodCallsFinalVersionSameFile extends JFrame {
	...
	public TracesTableChessFINALROUND2MethodCallsFinalVersionSameFile(String ProgramName) throws SQLException, IOException {
	...
	public static void main(String[] args) throws SQLException, IOException {
		...
		TracesTableChessFINALROUND2MethodCallsFinalVersionSameFile frame = new TracesTableChessFINALROUND2MethodCallsFinalVersionSameFile(
				ProgramName);

		String ProgramName2 = "gantt";
		frame = new TracesTableChessFINALROUND2MethodCallsFinalVersionSameFile(ProgramName2);

		String ProgramName3 = "itrust";
		frame = new TracesTableChessFINALROUND2MethodCallsFinalVersionSameFile(ProgramName3);

		String ProgramName4 = "jhotdraw";
		frame = new TracesTableChessFINALROUND2MethodCallsFinalVersionSameFile(ProgramName4);
