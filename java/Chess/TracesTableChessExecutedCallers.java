...
public class TracesTableChessExecutedCallers extends JFrame {
	int MethodID=0; 
	int MethodName=1; 
	int RequirementID=2; 
	...
	File fout = new File("C:\\Users\\mouna\\new_workspace\\SpoonProcessorFinal\\TableLogExecutedCalls.txt");
	FileOutputStream fos = new FileOutputStream(fout);
	
	File fout2 = new File("C:\\Users\\mouna\\new_workspace\\SpoonProcessorFinal\\PredictionEvaluationExecutedCalls.txt");
	...
	public TracesTableChessExecutedCallers() throws SQLException, IOException {
...
//DUPLICATE CLASSES
	...
	public static void main(String[] args) throws SQLException, IOException {
		...
		TracesTableChessExecutedCallers frame = new TracesTableChessExecutedCallers();
