...
//				};
		...
		String[] columnNames = {"0-Row",  "1-MethodID", "2-MethodName", "3-RequirementID", "4-RequirementName", "5-ClassID", "6-ClassName",
				...
				"120->1NPredictionClassLevelCallees Gold2V2", "121->1NPredictionClassLevelCallers Gold2V2", "122->1NPredictionMethodLevelCallees Gold2V2", 
				"123->1NPredictionMethodLevelCallers Gold2V2", "124->1TPredictionClassLevelCallees Gold2V2", "125->1TPredictionClassLevelCallers Gold2V2", 
				"126->1TPredictionMethodLevelCallees Gold2V2", "127->1TPredictionMethodLevelCallers Gold2V2", 
...
//				String traceGold2V2 = myclasstraceHashMap.getTrace2();
//				traceGold2V2=traceGold2V2.trim(); 
//				if (traceGold2V2.equals("T")) {
//					data[j][OwnerClassTGold2V2] = "1";
//					data[j][OwnerClassNGold2V2] = "0";
//					data[j][OwnerClassEGold2V2] = "0";
//					
//					PatternSetVariables("T",methodtrace,"100%","P1"); 
//					
//				//	System.out.println("OWNERCLASS T  "+j +" set to 1");
//				} else if (traceGold2V2.equals("N")) {
//					data[j][OwnerClassTGold2V2] = "0";
//					data[j][OwnerClassNGold2V2] = "1";
//					data[j][OwnerClassEGold2V2] = "0";
//					
//					PatternSetVariables("N",methodtrace,"100%","P1"); 
//				
//				//	System.out.println("OWNERCLASS N  "+j +" set to 1");
//				} else if (traceGold2V2.equals("E")) {
//					data[j][OwnerClassTGold2V2] = "0";
//					data[j][OwnerClassNGold2V2] = "0";
//					data[j][OwnerClassEGold2V2] = "1";
