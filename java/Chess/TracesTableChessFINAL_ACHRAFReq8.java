...
public class TracesTableChessFINAL_ACHRAFReq8 extends JFrame {
//	int TracePureGold=0; 
...
//	File fout2 = new File("C:\\Users\\mouna\\new_workspace\\SpoonProcessorFinal\\PredictionEvaluationChess.txt");
	File fout2 = new File("C:\\Users\\mouna\\ownCloud\\Share\\dumps\\CHESS_REQUIREMENTS_SEPARATED\\PredictionEvaluationChessACHRAFReq8.txt");

	FileOutputStream fos2 = new FileOutputStream(fout2);
	
	//File foutGold2 = new File("C:\\Users\\mouna\\new_workspace\\SpoonProcessorFinal\\PredictionEvaluationChessGold2.txt");
	File foutGold2 = new File("C:\\Users\\mouna\\ownCloud\\Share\\dumps\\CHESS_REQUIREMENTS_SEPARATED\\PredictionEvaluationChessGold2ACHRAFReq8.txt");
	...
	public TracesTableChessFINAL_ACHRAFReq8() throws SQLException, IOException {
		 ...
		 Object OwnerClassNVar = data[j][OwnerClassN]; 
			...
			//MAJORITY PARAMETER PREDICTION 
				...
				if((counterParameterT!=0 || counterParameterN!=0|| counterParameterE!=0)
						...
						if(methodtrace.getGold2()!=null && flagGold2==false  && methodtrace.Requirement.getID().equals("8")){
			...
			//}
					...
					if(CountMethodT>0 && CountMethodTCallee>0) {
						if(CountMethodN+CountMethodNCallee==0 && methodtrace.getGold()!=null ) {
							...
							if(methodtrace!=null && methodtrace.getGold2()!=null &&flagGold2==false  && methodtrace.Requirement.getID().equals("8")) {
								String Result=PureTCallersGold2.ComparePredictionToGold(methodtrace.getGold2().trim(), data[j][pureTCallersGold].toString()); 
					...
					if(CountMethodN>0 && CountMethodNCallee>0) {
						if(CountMethodT+CountMethodTCallee==0 && methodtrace.getGold()!=null ) {
							...
							if(methodtrace!=null &&  methodtrace.getGold2()!=null && flagGold2==false  && methodtrace.Requirement.getID().equals("8") ) {
								String Result=PureNCallersGold2.ComparePredictionToGold(methodtrace.getGold2().trim(), data[j][pureNCallersGold].toString()); 
	...
	boolean entered=false; 
		...
		*/
		...
		for(MethodTrace2  mymeth: methodtraces2) {
			...
			if(mymeth.gold2!=null) {
				if(mymeth.gold2.equals("T")) {
					gold2TraceTotal++; 
				}
			}
			if(mymeth.gold2!=null) {
			if(mymeth.gold2.equals("N")) {
				gold2NoTraceTotal++; 
			}
			}
		}
...
//				};
	...
	public static void main(String[] args) throws SQLException, IOException {
		...
		TracesTableChessFINAL_ACHRAFReq8 frame = new TracesTableChessFINAL_ACHRAFReq8();
