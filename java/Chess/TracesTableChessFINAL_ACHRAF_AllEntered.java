...
//							}
						//	if(methodtrace!=null && methodtrace.getGoldfinal()!=null &&flagGold2==false) {
								if(methodtrace!=null && methodtrace.getGoldfinal()!=null ) {
								 Result=PureTCallersGold2.ComparePredictionToGold(methodtrace.getGoldfinal().trim(), data[j][pureTCallersGold].toString()); 
...
//							}
							//if(methodtrace!=null &&  methodtrace.getGoldfinal()!=null && flagGold2==false ) {
								if(methodtrace!=null &&  methodtrace.getGoldfinal()!=null ) {
								 Result=PureNCallersGold2.ComparePredictionToGold(methodtrace.getGoldfinal().trim(), data[j][pureNCallersGold].toString()); 
