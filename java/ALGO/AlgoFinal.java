		...
		while (Equals(PredictionsOldHashMap, PredictionsNewHashMap) == false) {
			...
			for (MethodTrace methodtrace : MethodTracesHashmapValues) {
				...
				if (    !methodtrace.getMethod().getExtendedCallees().isEmpty() && !methodtrace.getMethod().getExtendedCallers().isEmpty()
						&& methodtrace.Method.getExtendedCallees().AllTs(methodtrace.Requirement, methodtraces2HashMap)
						&& methodtrace.getMethod().getExtendedCallers().AllTs(methodtrace.Requirement, methodtraces2HashMap)					
				...
				// PURE N PATTERN
						...
						&& methodtrace.getMethod().getExtendedCallees().AllNs(methodtrace.Requirement, methodtraces2HashMap)
						&& methodtrace.getMethod().getExtendedCallers().AllNs(methodtrace.Requirement, methodtraces2HashMap)
			...
			for (MethodTrace methodtrace : MethodTracesHashmapValues) {
				...
				// MIXED T PATTERN
				 if (!methodtrace.getMethod().getExtendedCallees().isEmpty() && !methodtrace.getMethod().getExtendedCallers().isEmpty() 
					&& methodtrace.getMethod().getExtendedCallees().AtLeast1T(methodtrace.Requirement, methodtraces2HashMap) 
					&& methodtrace.getMethod().getExtendedCallers().AtLeast1T(methodtrace.Requirement, methodtraces2HashMap) 
			...
			for (MethodTrace methodtrace : MethodTracesHashmapValues) {
				...
				&& methodtrace.getMethod().getExtendedCallees().AllTs(methodtrace.Requirement, methodtraces2HashMap) 
				&& methodtrace.getPrediction().trim().equals("E")
