...
public class TracesTableGANTTFINALROUND2MethodCallsGOLD6 extends JFrame {
...
//	File fout2 = new File("C:\\Users\\mouna\\new_workspace\\SpoonProcessorFinal\\PredictionEvaluationChess.txt");
	...
	public TracesTableGANTTFINALROUND2MethodCallsGOLD6() throws SQLException, IOException {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public LinkedHashMap<String, String>  function1SetToT(Object[][] data, int j, LinkedHashMap<String, String> PredictionsOldHashMap, LinkedHashMap<String, String> PredictionsNewHashMap, List<DatabaseInput> methodtraces22) throws SQLException {
		...
		for (DatabaseInput methodtrace : MethodTracesHashmapValues) {
			...
			data[j][Gold6] = methodtrace.gold6;
...
//		
	...
	/************************************************************************************************************************************************/
	/************************************************************************************************************************************************/
	public LinkedHashMap<String, String>  function1(Object[][] data, int j, LinkedHashMap<String, String> PredictionsOldHashMap, LinkedHashMap<String, String> PredictionsNewHashMap, List<DatabaseInput> methodtraces22) throws SQLException {
		// TODO Auto-generated method stub
		Collection<DatabaseInput> MethodTracesHashmapValues = methodtraces2HashMap.values(); 
		int ITERATION=0; 
		for (DatabaseInput methodtrace : methodtraces2) {
			...
			data[j][Gold] = methodtrace.gold;
			data[j][Subject] = methodtrace.subject;
			data[j][Gold6] = methodtrace.goldfinal;
			data[j][CallerClassesT] = 0;
			data[j][CallerClassesN] = 0;
			data[j][CallerClassesE] = 0;
			data[j][CallerMethodsT] = 0;
			...
			//PATTERN 1
			if(myclasstraceHashMap.getTrace6()!=null) {
				String traceGold6 = myclasstraceHashMap.getTrace6();
				traceGold6=traceGold6.trim(); 
				if (traceGold6.equals("T")) {
					data[j][OwnerClassTGOLD2] = "1";
					data[j][OwnerClassNGOLD2] = "0";
					data[j][OwnerClassEGOLD2] = "0";
...
//			System.out.println("-------------------------------------------");
			...
			System.out.println("=================>PATTERNS 2 AND 4 ITERATION  "+ITERATION+	"   PREDICTION VALUES "+NEWPATTERNMethodCalls.toString());
			 MyfinalHashMap = RetrievePredictionsHashMap( methodtraces2); 
			 WriteInDatabaseAndComputePrecisionAndRecall(MyfinalHashMap, NEWPATTERNMethodCalls);
			 //END  PRINT 
			System.out.println("HEEEEEEY");
...
//			st.executeUpdate(query); 
	...
	public static void main(String[] args) throws SQLException, IOException {
		...
		TracesTableGANTTFINALROUND2MethodCallsGOLD6 frame = new TracesTableGANTTFINALROUND2MethodCallsGOLD6();
