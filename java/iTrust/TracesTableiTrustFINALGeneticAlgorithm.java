...
public class TracesTableiTrustFINALGeneticAlgorithm extends JFrame {
	int Row=0; 
	int MethodID=1; 
	int MethodName=2; 
	int RequirementID=3; 
...
//	File fout2 = new File("C:\\Users\\mouna\\new_workspace\\SpoonProcessorFinal\\PredictionEvaluationChess.txt");
	...
	public TracesTableiTrustFINALGeneticAlgorithm() throws SQLException, IOException {
	...
	//	methodlist = db.getMethodlist();
		...
		Collection<MethodTraceSubjectTSubjectN> methodtracesvalues = methodtraces2HashMap.values(); 
...
//		 }
	...
	public static void main(String[] args) throws SQLException, IOException {
		...
		TracesTableiTrustFINALGeneticAlgorithm frame = new TracesTableiTrustFINALGeneticAlgorithm();
