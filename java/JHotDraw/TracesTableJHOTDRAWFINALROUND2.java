...
public class TracesTableJHOTDRAWFINALROUND2 extends JFrame {
...
//	File fout2 = new File("C:\\Users\\mouna\\new_workspace\\SpoonProcessorFinal\\PredictionEvaluationChess.txt");
	...
	public TracesTableJHOTDRAWFINALROUND2() throws SQLException, IOException {
...
//				};
	...
	private void WriteInDatabaseAndComputePrecisionAndRecall(
			LinkedHashMap<String, DatabaseInput> MyfinalHashMap) throws SQLException {
...
//			st.executeUpdate(query); 
			...
			System.out.println(myvalue.getGold4()+"   "+myvalue.getPrediction());
				if(myvalue.getGold4()!=null && myvalue.getPrediction()!=null) {
					String Result=NEWPATTERNMethodCalls.ComparePredictionToGold(myvalue.getGold4().trim(), myvalue.getPrediction().trim()); 
					NEWPATTERNMethodCalls.UpdateCounters(Result, NEWPATTERNMethodCalls);
				}
		//System.out.println(MyfinalHashMap.size()+" "+j);
			j++; 
		}
	...
	public static void main(String[] args) throws SQLException, IOException {
		...
		TracesTableJHOTDRAWFINALROUND2 frame = new TracesTableJHOTDRAWFINALROUND2();
