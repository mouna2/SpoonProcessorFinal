...
public class TracesTableJHotDrawFINALGeneticAlgorithm extends JFrame {
	int Row=0; 
	int MethodID=1; 
	int MethodName=2; 
	int RequirementID=3; 
...
//	File fout2 = new File("C:\\Users\\mouna\\new_workspace\\SpoonProcessorFinal\\PredictionEvaluationChess.txt");
	...
	public TracesTableJHotDrawFINALGeneticAlgorithm() throws SQLException, IOException {
		...
		bw.write("RowNumber, MethodID, MethodName, RequirementID, RequirementName, ClassID, ClassName, Gold, gold4, Subject, OwnerClassT, OwnerClassN, "
	...
	//	methodlist = db.getMethodlist();
		...
		for (MethodTrace methodtrace : MethodTracesHashmapValues) {
			...
			if (trace.equals("T")) {
				...
				data[j][OwnerClassT] = "null";
				data[j][OwnerClassN] = "null";
				data[j][OwnerClassE] = "null";
			}
			...
			if(myclasstraceHashMap.getTrace4()!=null) {
				...
				data[j][OwnerClassTGOLD2] = "null";
				data[j][OwnerClassNGOLD2] = "null";
				data[j][OwnerClassEGOLD2] = "null";
			}
		...
		/////////////////////////////////	
			...
			MethodDetails mymethodobje = linkedmethodhashmap.get(methodtrace.MethodRepresentation.methodid); 
			...
			for ( Parameter2 myparam : mymethodobje.getParameters()) {
				...
				if(mycallerclass!=null) {
					...
					String mytrace2=mycallerclass.getTrace4(); 
					if(mytrace2!=null) {
...
//			}
		...
		//	data[j][CallerClassesNumber] = myclasstracesCallers.size();
			...
			for (ClassTrace2 mycalleeclass : mycalleeclasses) {
				...
				if(mycalleeclass.getTrace4()!=null) {
					if (mycalleeclass.getTrace4().trim().trim().equals("T")) {
						CountMethodTCalleeGOLD2++;
					} else if (mycalleeclass.getTrace4().trim().trim().equals("N")) {
						CountMethodNCalleeGOLD2++;
					} else if (mycalleeclass.getTrace4().trim().trim().equals("E")) {
						...
						//}
								...
								//ALL T CLASS LEVEL CALLERS CALLEES 
									...
									if(methodtrace.gold4!=null) {
										...
										PredictionStandardHashMap.put(key, "null"); 
									...
									PredictionCLASSTRACEMethodLevelPureGold2HashMapACROSS.put(key,"null");
									PredictionCLASSTRACEMethodLevelMixedGold2HashMapACROSS.put(key,"null"); 
									...
									if((counterParameterTGOLD2!=0 || counterParameterNGOLD2!=0|| counterParameterEGOLD2!=0)
											...
											//if(methodtrace.getGold4()!=null) {
												if( methodtrace.getGold4()!=null) {
												String Result=MajorityParametersClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][MajorityParametersGOLD2].toString()); 
									...
									if (counterParameterNGOLD2 >=1 )
										...
										if(methodtrace.getGold4()!=null) {
										String Result=AtLeast1NParameterClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AtLeast1NParameterGOLD2].toString()); 
									...
									if (counterParameterNGOLD2 >=2 )
										...
										if(methodtrace.getGold4()!=null) {
											...
											String Result=AtLeast2NParameterClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AtLeast2NParameterGOLD2].toString()); 
								...
								//AT LEAST 1T PREDICTION PARAMETER
									...
									if (counterParameterTGOLD2 >=1 )
										...
										if(methodtrace.getGold4()!=null) {
										String Result=AtLeast1TParameterClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AtLeast1TParameterGOLD2].toString()); 
									...
									//AT LEAST 2T PREDICTION PARAMETER
										...
										if (counterParameterTGOLD2 >=2 )
											...
											if(methodtrace.getGold4()!=null) {
											String Result=AtLeast2TParameterClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AtLeast2TParameterGOLD2].toString()); 
									...
									if(counterParameterEGOLD2==0 && counterParameterNGOLD2==0 && counterParameterTGOLD2>=1) {
											...
											if(methodtrace.getGold4()!=null) {
											String Result=AllTParameterClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AllTParametersGOLD2].toString()); 
									...
									if(counterParameterTGOLD2==0 && counterParameterEGOLD2==0 && counterParameterNGOLD2>=1) {
											...
											if(methodtrace.getGold4()!=null) {
											String Result=AllNParameterClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AllNParametersGOLD2].toString()); 
									...
									if((CounterTraceClassCalleeTGOLD2!=0 || CounterTraceClassCalleeNGOLD2!=0 || CounterTraceClassCalleeEGOLD2!=0)
										...
										if(true && methodtrace.getGold4()!=null && data[j][MajorityClassLevelCalleesGOLD2]!=null) {
										String Result=MajorityClassLevelCalleesClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][MajorityClassLevelCalleesGOLD2].toString()); 
									...
									if((CounterTraceClassCallerTGOLD2!=0 || CounterTraceClassCallerNGOLD2!=0 ||CounterTraceClassCallerEGOLD2!=0)
										...
										if(methodtrace.getGold4()!=null) {
										String Result=MajorityClassLevelCallersClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][MajorityClassLevelCallersGOLD2].toString()); 
									...
									if((CountMethodTCalleeGOLD2!=0 || CountMethodNCalleeGOLD2!=0 || CountMethodECalleeGOLD2!=0)/*||
										...
										if(methodtrace.getGold4()!=null) {
										String Result=MajorityMethodLevelCalleesClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][MajorityMethodLevelCalleesGOLD2].toString()); 
									...
									if((CountMethodTGOLD2!=0 || CountMethodNGOLD2!=0|| CountMethodEGOLD2!=0 )/*||
										...
										if(methodtrace.getGold4()!=null) {
										String Result=MajorityMethodLevelCallersClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][MajorityMethodLevelCallersGOLD2].toString()); 
									...
									//1AT LEAST 1N PREDICTION CLASS LEVEL CALLERS 
										...
										if (CounterTraceClassCallerNGOLD2 >=1 )
											...
											String NEWVAR=var.toString(); 
											if(methodtrace.getGold4()!=null) {
											String Result=AtLeastNPredictionClassLevelCallersClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AtLeast1NPredictionClassLevelCallersGOLD2].toString()); 
									...
									//2AT LEAST 1T PREDICTION CLASS LEVEL CALLERS 
										...
										if (CounterTraceClassCallerTGOLD2 >=1 )
											...
											if(methodtrace.getGold4()!=null) {
											String Result=AtLeastTPredictionClassLevelCallersClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AtLeast1TPredictionClassLevelCallersGOLD2].toString()); 
									...
									//3AT LEAST 1N PREDICTION CLASS LEVEL CALLEES 
										...
										if (CounterTraceClassCalleeNGOLD2 >=1 )
											...
											if(methodtrace.getGold4()!=null) {
											String Result=AtLeastNPredictionClassLevelCalleesClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AtLeast1NPredictionClassLevelCalleesGOLD2].toString()); 
									...
									//4AT LEAST 1T PREDICTION CLASS LEVEL CALLEES 
										...
										if (CounterTraceClassCalleeTGOLD2 >=1 )
											...
											if(methodtrace.getGold4()!=null) {
											String Result=AtLeastTPredictionClassLevelCalleesClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AtLeast1TPredictionClassLevelCalleesGOLD2].toString()); 
									...
									//5AT LEAST 1N PREDICTION METHOD LEVEL CALLERS 
										...
										if (CountMethodNGOLD2 >=1 )
											...
											if(methodtrace.getGold4()!=null) {
											String Result=AtLeastNPredictionMethodLevelCallersClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AtLeast1NPredictionMethodLevelCallersGOLD2].toString()); 
									...
									//6AT LEAST 1T PREDICTION METHOD LEVEL CALLERS 
										...
										if (CountMethodTGOLD2 >=1 )
											...
											if(methodtrace.getGold4()!=null) {
											String Result=AtLeastTPredictionMethodLevelCallersClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AtLeast1TPredictionMethodLevelCallersGOLD2].toString()); 
									...
									//7AT LEAST 1N PREDICTION METHOD LEVEL CALLEES 
										...
										if (CountMethodNCalleeGOLD2 >=1 )
											...
											if(methodtrace.getGold4()!=null) {
											String Result=AtLeastNPredictionMethodLevelCalleesClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AtLeast1NPredictionMethodLevelCalleesGOLD2].toString()); 
									...
									//8AT LEAST 1T PREDICTION METHOD LEVEL CALLEES 
										...
										if (CountMethodTCalleeGOLD2 >=1 )
											...
											if(methodtrace.getGold4()!=null) {
											String Result=AtLeastTPredictionMethodLevelCalleesClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AtLeast1TPredictionMethodLevelCalleesGOLD2].toString()); 
									...
									/**************************************************************************************************************/
										...
										//AT LEAST 2N PREDICTION CLASS LEVEL CALLEES 
											...
											if (CounterTraceClassCalleeNGOLD2 >=2 )
												...
												String NEWVAR=var.toString(); 
												if(methodtrace.getGold4()!=null) {
													String Result=AtLeast2NPredictionClassLevelCalleesClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AtLeast2NPredictionClassLevelCalleesGOLD2].toString()); 
										...
										if(methodtrace.getGold4()!=null) {
										String Result=AtLeast2TPredictionClassLevelCalleesClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AtLeast2TPredictionClassLevelCalleesGOLD2].toString()); 
										...
										//AT LEAST 2N PREDICTION METHOD LEVEL CALLERS 
											...
											if (CountMethodNGOLD2 >=2 )
												...
												if(methodtrace.getGold4()!=null) {
												String Result=AtLeast2NPredictionMethodLevelCallersClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AtLeast2NPredictionMethodLevelCallersGOLD2].toString()); 
											...
											if(methodtrace.getGold4()!=null) {
											String Result=AtLeast2TPredictionClassLevelCallersClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AtLeast2TPredictionClassLevelCallersGOLD2].toString()); 
										...
										if(methodtrace.getGold4()!=null) {
										String Result=AtLeast2TPredictionMethodLevelCallersClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AtLeast2TPredictionMethodLevelCallersGOLD2].toString()); 
										...
										if(methodtrace.getGold4()!=null) {
										String Result=AtLeast2NPredictionMethodLevelCalleesClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AtLeast2NPredictionMethodLevelCalleesGOLD2].toString()); 
										...
										if(methodtrace.getGold4()!=null) {
											String Result=AtLeast2TPredictionMethodLevelCalleesClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AtLeast2TPredictionMethodLevelCalleesGOLD2].toString()); 
										...
										if(methodtrace.getGold4()!=null) {
										String Result=AtLeast2NPredictionClassLevelCallersClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AtLeast2NPredictionClassLevelCallersGOLD2].toString()); 
									...
									if(CountMethodNCalleeGOLD2==0 && CountMethodECalleeGOLD2==0 && CountMethodTCalleeGOLD2>=1) {
											...
											if(methodtrace.getGold4()!=null) {
											String Result=AllTMethodLevelCalleesClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AllTMethodLevelCalleesGOLD2].toString()); 
									...
									if(CountMethodNGOLD2==0 && CountMethodEGOLD2==0  && CountMethodTGOLD2>=1) {
											...
											if(methodtrace.getGold4()!=null) {
											String Result=AllTMethodLevelCallersClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AllTMethodLevelCallersGOLD2].toString()); 
									...
									if(CounterTraceClassCallerEGOLD2==0 && CounterTraceClassCallerNGOLD2==0 && CounterTraceClassCallerTGOLD2>=1) {
											...
											if(methodtrace.getGold4()!=null) {
											String Result=AllTClassLevelCallersClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AllTClassLevelCallersGOLD2].toString()); 
									...
									if(CounterTraceClassCalleeEGOLD2==0 && CounterTraceClassCalleeNGOLD2==0 && CounterTraceClassCalleeTGOLD2>=1) {
											...
											if(methodtrace.getGold4()!=null) {
											String Result=AllTClassLevelCalleesClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AllTClassLevelCalleesGOLD2].toString()); 
									...
									if(CounterTraceClassCallerTGOLD2==0 && CounterTraceClassCallerEGOLD2==0 && CounterTraceClassCallerNGOLD2>=1) {
											...
											if(methodtrace.getGold4()!=null) {
											String Result=AllNClassLevelCallersClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AllNClassLevelCallersGOLD2].toString()); 
									...
									//ALL N CLASS LEVEL CALLEES 
										...
										if(CounterTraceClassCalleeTGOLD2==0 && CounterTraceClassCalleeEGOLD2==0 && CounterTraceClassCalleeNGOLD2>=1) {
											...
											if(methodtrace.getGold4()!=null) {
											String Result=AllNClassLevelCalleesClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AllNClassLevelCalleesGOLD2].toString()); 
									...
									//ALL N METHOD LEVEL CALLERS 
										...
										if(CountMethodTGOLD2==0 && CountMethodEGOLD2==0 && CountMethodNGOLD2>=1) {	
											...
											if(methodtrace.getGold4()!=null) {
											String Result=AllNMethodLevelCallersClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AllNMethodLevelCallersGOLD2].toString()); 
									...
									//ALL N METHOD LEVEL CALLEES 
										...
										if(CountMethodTCalleeGOLD2==0 && CountMethodECalleeGOLD2==0 && CountMethodNCalleeGOLD2>=1) {
											...
											if(methodtrace.getGold4()!=null) {
												String Result=AllNMethodLevelCalleesClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AllNMethodLevelCalleesGOLD2].toString()); 
								...
								if(CountMethodNCalleeGOLD2==0 && CountMethodECalleeGOLD2==0 && CountMethodTCalleeGOLD2>=2) {
										...
										if(methodtrace.getGold4()!=null) {
										String Result=AllTMethodLevelCalleesClassAtLeast2TGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AllTMethodLevelCalleesAtLeast2TGOLD2].toString()); 
								...
								if(CountMethodNGOLD2==0 && CountMethodEGOLD2==0  && CountMethodTGOLD2>=2) {
										...
										if(methodtrace.getGold4()!=null) {
										String Result=AllTMethodLevelCallersClassAtLeast2TGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AllTMethodLevelCallersAtLeast2TGOLD2].toString()); 
								...
								if(CounterTraceClassCallerEGOLD2==0 && CounterTraceClassCallerNGOLD2==0 && CounterTraceClassCallerTGOLD2>=2) {
										...
										if(methodtrace.getGold4()!=null) {
										String Result=AllTClassLevelCallersClassAtLeast2TGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AllTClassLevelCallersAtLeast2TGOLD2].toString()); 
								...
								if(CounterTraceClassCalleeEGOLD2==0 && CounterTraceClassCalleeNGOLD2==0 && CounterTraceClassCalleeTGOLD2>=2) {
										...
										if(methodtrace.getGold4()!=null) {
										String Result=AllTClassLevelCalleesClassAtLeast2TGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AllTClassLevelCalleesAtLeast2TGOLD2].toString()); 
								...
								if(CounterTraceClassCallerTGOLD2==0 && CounterTraceClassCallerEGOLD2==0 && CounterTraceClassCallerNGOLD2>=2) {
										...
										if(methodtrace.getGold4()!=null) {
										String Result=AllNClassLevelCallersClassAtLeast2NGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AllNClassLevelCallersAtLeast2NGOLD2].toString()); 
								...
								//ALL N CLASS LEVEL CALLEES AT LEAST 2N
									...
									if(CounterTraceClassCalleeTGOLD2==0 && CounterTraceClassCalleeEGOLD2==0 && CounterTraceClassCalleeNGOLD2>=2) {
										...
										if(methodtrace.getGold4()!=null) {
										String Result=AllNClassLevelCalleesClassAtLeast2NGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AllNClassLevelCalleesAtLeast2NGOLD2].toString()); 
								...
								//ALL N METHOD LEVEL CALLERS AT LEAST 2N
									...
									if(CountMethodTGOLD2==0 && CountMethodEGOLD2==0 && CountMethodNGOLD2>=2) {	
										...
										if(methodtrace.getGold4()!=null) {
										String Result=AllNMethodLevelCallersClassAtLeast2NGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AllNMethodLevelCallersAtLeast2NGOLD2].toString()); 
								...
								//ALL N METHOD LEVEL CALLEES AT LEAST 2N
									...
									if(CountMethodTCalleeGOLD2==0 && CountMethodECalleeGOLD2==0 && CountMethodNCalleeGOLD2>=2) {
										...
										if(methodtrace.getGold4()!=null) {
											String Result=AllNMethodLevelCalleesClassAtLeast2NGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AllNMethodLevelCalleesAtLeast2NGOLD2].toString()); 
									...
									/**************************************************************************************************************/
										...
										//ALL N METHOD LEVEL CALLERS CALLEES 
											...
											if(CountMethodTCalleeGOLD2==0 && CountMethodTGOLD2==0 && CountMethodNCalleeGOLD2>=1 && CountMethodNGOLD2>=1) {
												...
												if(methodtrace.getGold4()!=null) {
													String Result=AllNMethodLevelCallersCalleesClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AllNMethodLevelCallersCalleesGOLD2].toString()); 
									...
									//}
											...
											//ALL T METHOD LEVEL CALLERS CALLEES 
												...
												if(CountMethodNGOLD2==0 && CountMethodNCalleeGOLD2==0 && CountMethodTCalleeGOLD2>=1 && CountMethodTGOLD2>=1) {
													...
													if(methodtrace.getGold4()!=null) {
														String Result=AllTMethodLevelCallersCalleesClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AllTMethodLevelCallersCalleesGOLD2].toString()); 
												...
												//ALL N CLASS LEVEL CALLERS CALLEES 
													...
													if(CounterTraceClassCalleeTGOLD2==0 && CounterTraceClassCallerTGOLD2==0 && CounterTraceClassCalleeNGOLD2>=1 && CounterTraceClassCallerNGOLD2>=1) {
														...
														if(methodtrace.getGold4()!=null) {
															String Result=AllNClassLevelCallersCalleesClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AllNClassLevelCallersCalleesGOLD2].toString()); 
											...
											//}
													...
													//ALL T CLASS LEVEL CALLERS CALLEES 
														...
														if(CounterTraceClassCalleeNGOLD2==0 && CounterTraceClassCallerNGOLD2==0 && CounterTraceClassCalleeTGOLD2>=1 && CounterTraceClassCallerTGOLD2>=1) {
															...
															if(methodtrace.getGold4()!=null) {
																String Result=AllTClassLevelCallersCalleesClassGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), data[j][AllTClassLevelCallersCalleesGOLD2].toString()); 
	...
	if(CountMethodTACHRAFGold2>0 && CountMethodTACHRAFCalleeGold2>0) {
											...
											String Result=ACHRAFTracePureGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), TracePureGold2Value); 
											ACHRAFTracePureGold2.UpdateCounters(Result, ACHRAFTracePureGold2);
											}
											
											if(methodtrace.getGold4()!=null ) {
												data[j][ACHRAFTRACEMixedGOLD2]=TraceMixedGold2Value; 
												String Result=ACHRAFTraceMixedGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), TraceMixedGold2Value); 
										...
										boolean entered=false; 
										if(CountMethodTACHRAFGold2+CountMethodTACHRAFCalleeGold2==0 && methodtrace.getGold4()!=null ) {
										...
										if(methodtrace.getGold4()!=null ) {
											String Result=ACHRAFNOTracePureGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), NOTracePureGold2Value); 
											ACHRAFNOTracePureGold2.UpdateCounters(Result, ACHRAFNOTracePureGold2);
											}
											
											if(methodtrace.getGold4()!=null ) {
												String Result=ACHRAFNOTraceMixedGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), NOTraceMixedGold2Value); 
...
if(CountMethodTGOLD2>0 && CountMethodTCalleeGOLD2>0) {
		...
		boolean entered=false; 
		if(CountMethodNGOLD2+CountMethodNCalleeGOLD2==0 && methodtrace.getGold4()!=null ) {
...
//		if(true) {
		...
		String Result=PredictionCLASSTRACEMethodLevelPureGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), TracePureGold2ValueMethodLevel); 
		...
		if(methodtrace.getGold4()!=null ) {
			...
			String Result=PredictionCLASSTRACEMethodLevelMixedGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), TraceMixedGold2ValueMethodLevel); 
...
//		}
	...
	boolean entered=false; 
	if(CountMethodTGOLD2+CountMethodTCalleeGOLD2==0 && methodtrace.getGold4()!=null ) {
	...
	if(methodtrace.getGold4()!=null ) {
		String Result=PredictionCLASSNOTRACEMethodLevelPureGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), NOTracePureGold2ValueMethodLevel); 
		...
		if(methodtrace.getGold4()!=null ) {
			String Result=PredictionCLASSNOTRACEMethodLevelMixedGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), NOTraceMixedGold2ValueMethodLevel); 
...
if(CounterTraceClassCallerTGOLD2>0 && CounterTraceClassCalleeTGOLD2>0) {
	...
	boolean entered=false; 
	if(CounterTraceClassCallerNGOLD2+CounterTraceClassCalleeNGOLD2==0 && methodtrace.getGold4()!=null ) {
	...
	String Result=PredictionCLASSTRACEClassLevelPureGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), TracePureGold2ValueClassLevel); 
	...
	if(methodtrace.getGold4()!=null ) {
		...
		String Result=PredictionCLASSTRACEClassLevelMixedGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), TraceMixedGold2ValueClassLevel); 
...
boolean entered=false; 
if(CounterTraceClassCallerTGOLD2+CounterTraceClassCalleeTGOLD2==0 && methodtrace.getGold4()!=null ) {
...
if(methodtrace.getGold4()!=null ) {
	String Result=PredictionCLASSNOTRACEClassLevelPureGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), NOTracePureGold2ValueClassLevel); 
	...
	if(methodtrace.getGold4()!=null ) {
		String Result=PredictionCLASSNOTRACEClassLevelMixedGold2.ComparePredictionToGold(methodtrace.getGold4().trim(), NOTraceMixedGold2ValueClassLevel); 
...
boolean entered=false; 
if(CountMethodNGOLD2ACROSS+CountMethodNGOLD2ACROSSCallee==0 && methodtrace.getGold4()!=null ) {
...
String Result=PredictionCLASSTRACEMethodLevelPureGold2ACROSS.ComparePredictionToGold(methodtrace.getGold4().trim(), TracePureGold2ValueMethodLevelACROSS); 
...
String Result=PredictionCLASSTRACEMethodLevelMixedGold2ACROSS.ComparePredictionToGold(methodtrace.getGold4().trim(), TraceMixedGold2ValueMethodLevelACROSS); 
...
boolean entered=false; 
if(CountMethodTGOLD2ACROSS+CountMethodTGOLD2ACROSSCallee==0 && methodtrace.getGold4()!=null ) {
...
if(methodtrace.getGold4()!=null ) {
String Result=PredictionCLASSNOTRACEMethodLevelPureGold2ACROSS.ComparePredictionToGold(methodtrace.getGold4().trim(), NOTracePureGold2ValueMethodLevelACROSS); 
...
if(methodtrace.getGold4()!=null ) {
String Result=PredictionCLASSNOTRACEMethodLevelMixedGold2ACROSS.ComparePredictionToGold(methodtrace.getGold4().trim(), NOTraceMixedGold2ValueMethodLevelACROSS); 
...
boolean entered=false; 
if(CounterTraceClassCallerNGOLD2ACROSS+CounterTraceClassCalleeNGOLD2ACROSS==0 && methodtrace.getGold4()!=null ) {
...
String Result=PredictionCLASSTRACEClassLevelPureGold2ACROSS.ComparePredictionToGold(methodtrace.getGold4().trim(), TracePureGold2ValueClassLevelACROSS); 
...
String Result=PredictionCLASSTRACEClassLevelMixedGold2ACROSS.ComparePredictionToGold(methodtrace.getGold4().trim(), TraceMixedGold2ValueClassLevelACROSS); 
...
boolean entered=false; 
if(CounterTraceClassCallerTGOLD2ACROSS+CounterTraceClassCalleeTGOLD2ACROSS==0 && methodtrace.getGold4()!=null ) {
...
if(methodtrace.getGold4()!=null ) {
String Result=PredictionCLASSNOTRACEClassLevelPureGold2ACROSS.ComparePredictionToGold(methodtrace.getGold4().trim(), NOTracePureGold2ValueClassLevelACROSS); 
...
if(methodtrace.getGold4()!=null ) {
String Result=PredictionCLASSNOTRACEClassLevelMixedGold2ACROSS.ComparePredictionToGold(methodtrace.getGold4().trim(), NOTraceMixedGold2ValueClassLevelACROSS); 
...
failGold2++; 
			...
			bwGold2TableLog.write(data[j][Row] + "," +data[j][MethodID] + "," + data[j][MethodName] + "," + data[j][RequirementID] + "," + data[j][RequirementName] + "," + data[j][ClassID] + ","
					+ data[j][ClassName] + "," + data[j][gold4] + "," + data[j][Subject] + "," + data[j][OwnerClassTGOLD2] + "," + data[j][OwnerClassNGOLD2] + ","
...
//		 }
	...
	public static void main(String[] args) throws SQLException, IOException {
		...
		TracesTableJHotDrawFINALGeneticAlgorithm frame = new TracesTableJHotDrawFINALGeneticAlgorithm();
